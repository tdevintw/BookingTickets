        ...
        <div class="">
            <div class="row">
                <div class="col-sm-8 offset-sm-2 text-gray-50 text-center">
                    ...
                    <a class="bg-green-400 cursor-pointer px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg">
                        Got to Home
                    </a>
                </div>
            </div>
